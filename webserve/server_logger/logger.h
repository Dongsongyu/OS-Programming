/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Wed 04 Dec 2024 06:45:56 PM CST
 ************************************************************************/
#include<fstream>
#include<string>
#include<chrono>
#include<ctime>
#include<cstdarg>//引入处理可变参数的库
...
//定义宏以简化日志记录操作,提供INFO、WARNING、ERROR三个日志级别的宏
...
//当你在代码调用LOG_INFO("Hello, %s", name)时
//宏会在编译阶段替换成Logger::LogMessage(INFO,"Hello, %s", name)